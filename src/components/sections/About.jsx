  ...
  return (
    <section id='about' className='min-h-screen flex items-center justify-center py-20'>
        ...
        <div className='max-w-3xl mx-auto px-4'>
            <h2 className='text-3xl font-bold mb-8 bg-gradient-to-r from-blue-500 to-purple-700 bg-clip-text text-transparent items-center justify-center flex'>About Me</h2>
                    ...
                    <div className='rounded-xl p-6 hover:translate-y-1 transition-all'>
                        ...
                        <div className='flex flex-wrap gap-2'>
                            {frontendSkills.map((skill, key) => (
                                <div key={key} className='flex items-center gap-2 bg-blue-500/10 py-1 px-3 bg-gradient-to-r from-blue-300 to-purple-600 bg-clip-text text-transparent border border-purple-900 rounded-full text-sm hover:bg-purple-500/70 hover:shadow-[0_0_15px_rgba(128,90,213,0.7)] transition'>
